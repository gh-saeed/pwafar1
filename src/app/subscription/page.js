        ...
        <div className="fixed bottom-0 left-0 w-full z-40">
          <div className="mx-auto w-full max-w-md">
            <div className="grid grid-cols-5 bg-white py-4 rounded-t-xl shadow-lg">
              ...
              <NavItem icon={<MessageSquareText className="w-6 h-6" />} label="پشتیبانی" href="/support" />
              <div className="flex justify-center">
                <div className="w-12 h-12 bg-teal-600 rounded-full flex items-center justify-center -mt-6 shadow-lg">
                  <ShoppingCart className="w-6 h-6 text-white" />
                </div>
              </div>
              <NavItem icon={<BookText className="w-6 h-6" />} label="آموزش" href="/education" />
              <NavItem icon={<Users className="w-6 h-6" />} label="حساب کاربری" href="/account" />
            </div>
          </div>
        </div>
      </div>
